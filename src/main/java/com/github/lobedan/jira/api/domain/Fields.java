...
public class Fields {
    ...
    public boolean equals(Object o) {
        ...
        if (aggregateTime != fields.aggregateTime) return false;
        if (aggregateTimeSpent != fields.aggregateTimeSpent) return false;
        if (timeEstimate != fields.timeEstimate) return false;
        if (timeOriginalEstimate != fields.timeOriginalEstimate) return false;
        ...
        if (aggregateProgress != null ? !aggregateProgress.equals(fields.aggregateProgress) : fields.aggregateProgress != null)
            return false;
        if (assingee != null ? !assingee.equals(fields.assingee) : fields.assingee != null) return false;
        if (!Arrays.equals(components, fields.components)) return false;
        if (created != null ? !created.equals(fields.created) : fields.created != null) return false;
        if (description != null ? !description.equals(fields.description) : fields.description != null) return false;
        if (dueDate != null ? !dueDate.equals(fields.dueDate) : fields.dueDate != null) return false;
        if (!Arrays.equals(issuelinks, fields.issuelinks)) return false;
        if (!Arrays.equals(labels, fields.labels)) return false;
        if (lastViewed != null ? !lastViewed.equals(fields.lastViewed) : fields.lastViewed != null) return false;
        if (priority != null ? !priority.equals(fields.priority) : fields.priority != null) return false;
        if (progress != null ? !progress.equals(fields.progress) : fields.progress != null) return false;
        if (project != null ? !project.equals(fields.project) : fields.project != null) return false;
        if (reporter != null ? !reporter.equals(fields.reporter) : fields.reporter != null) return false;
        if (resolution != null ? !resolution.equals(fields.resolution) : fields.resolution != null) return false;
        ...
        if (!Arrays.equals(subtasks, fields.subtasks)) return false;
        if (title != null ? !title.equals(fields.title) : fields.title != null) return false;
        if (type != null ? !type.equals(fields.type) : fields.type != null) return false;
        if (updated != null ? !updated.equals(fields.updated) : fields.updated != null) return false;
        if (watches != null ? !watches.equals(fields.watches) : fields.watches != null) return false;
