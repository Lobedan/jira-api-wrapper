...
public class Assingee {
  ...
  public boolean equals(Object o) {
    ...
    if (active != assingee.active) {
      return false;
    }
    if (emailAdress != null ? !emailAdress.equals(assingee.emailAdress) : assingee.emailAdress != null) {
      return false;
    }
    if (name != null ? !name.equals(assingee.name) : assingee.name != null) {
      return false;
    }
    if (self != null ? !self.equals(assingee.self) : assingee.self != null) {
      return false;
    }
    if (userName != null ? !userName.equals(assingee.userName) : assingee.userName != null) {
      return false;
    }
