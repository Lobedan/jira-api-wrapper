...
public class Watches {
    ...
    public boolean equals(Object o) {
        ...
        if (isWatching != watches.isWatching) return false;
        if (watchCount != watches.watchCount) return false;
        if (self != null ? !self.equals(watches.self) : watches.self != null) return false;
