...
public class Reporter {
    ...
    public boolean equals(Object o) {
        ...
        if (active != reporter.active) return false;
        ...
        if (self != null ? !self.equals(reporter.self) : reporter.self != null) return false;
        if (userName != null ? !userName.equals(reporter.userName) : reporter.userName != null) return false;
