...
public class Search {
  ...
  public boolean equals(Object o) {
    ...
    if (maxResults != search.maxResults) {
      return false;
    }
    if (startAt != search.startAt) {
      return false;
    }
    if (total != search.total) {
      return false;
    }
    if (expand != null ? !expand.equals(search.expand) : search.expand != null) {
      return false;
    }
    if (issues != null ? !issues.equals(search.issues) : search.issues != null) {
      return false;
    }
